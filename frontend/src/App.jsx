...
// to scroll to top when page reload or new page is vistied
...
const ScrollToTop =() =>{
  ...
  const App = () => {
    ...
    useEffect(()=>{
      (async()=>{
        try{
          ...
          console.error("error boostrapping auth",err);
        } finally{
          setIsLoading(false);
    ...
    useEffect(()=>{
      try{
        localStorage.setItem("transactions",JSON.stringify(tranasactions));
      }
      catch(err){
  ...
  if (isLoading) {
    ...
    return (
      ...
      <Routes>
        ...
        <Route element={
          <ProtectedRoute user={user}>
            <Layout user={user} onLogout={handlegLogout}
      ...
      >
        ...
        onUpdateProfile={updateUserData} onLogout={handlegLogout}/>}/>
        </Route>

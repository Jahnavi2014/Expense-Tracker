...
const Signup = ({ onSignup, API_URL="https://expense-tracker-7jlx.onrender.com/api" }) => {
 ...
 // to validate thet all fileds are filled by user or not 
      ...
      <div className={signupStyles.cardContainer}>
        <div className={signupStyles.header}>
          ...
          <p className={signupStyles.headerSubtitle}>
            Join ExpenseTrack to manage your finances
          </p>
        </div>

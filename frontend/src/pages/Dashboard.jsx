...
import { ArrowDown, BarChart2, ChevronDown,TrendingUp as ProfitIcon,PieChart as PieChartIcon,ChevronUp, DollarSign, PiggyBank, Plus, ShoppingCart, TrendingDown, TrendingUp, Wallet, WalletIcon} from 'lucide-react';
...
const API_BASE = "https://expense-tracker-7jlx.onrender.com/api";
const getAuthHeader =()=>{
...
//function to check if a date is within the range
  ...
  }, [currentTimeFrameData, timeFrame]); // the graph wii be fill according to this data .
  ...
  const handleAddTransaction = async()=>{
    ...
    try{
      ...
      console.error(
        "Failed to add Transactions",err?.response || err.message || err
      );
    } finally{
      setLoading(false);
    }
